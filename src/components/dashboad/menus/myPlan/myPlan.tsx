       ...
       <div>
        <p className="text-[20px] font-extrabold mt-4">
          Canceled on: <span className="text-[#FB8A2E]">{Dte}</span>
            ...
            <Button className="!bg-[#FB8A2E] !text-white !rounded-md !mt-5 !w-60 !h-11 !font-bold" onClick={()=>{dispatch(updateSideBar('update-plan')); dispatch(updatePlainId(planData?.id))} }>Update Plan</Button>
         </div>
      </>
   );
};
