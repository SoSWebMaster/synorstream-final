...
import { updateIsPlaying, updateCurrentSongId, updateCurrentSong, nextSong, prevSong, updateCurrentVolume } from "../../store/music-store";
...
function PlayerContent() {
   ...
   return (
      <div className="fixed bottom-0 left-0 right-0 z-50 text-white bg-black">
         <div className="flex items-center justify-between p-3 py-4 gap-x-2 2xl:px-20 md:px-10">
            ...
            <div className="w-[8%] ">
               <p className="!hidden md:!block">
                  <span className="ellipsis text-[18px]">{currentSong.name}</span>
                  <span
                     ...
                     {!isPlaying && (
                        <PlayIcon
                           ...
                           onClick={() => {
                              ...
                              if (!currentSongId)
                                 dispatch(updateCurrentSongId(currentSong.id));
